...
> **現行実装（2026-09-26）**: 既定モデルはGemini 3.8 Flash / 3.1 Flash TTS Preview、定期実行は04:00 JST。台本は記事タイトル・媒体名・URLから生成し、元記事本文との事実照合は行わない。以下のモデル・料金比較は当初の構想であり、現行のAPI利用料金はアカウントのプランによる。
...
| 編集適合性 | テクノロジーまたは経済の時事ニュースが中心で、日刊ニュースとして紹介できること。連載・チュートリアル・広告記事が中心の媒体は採用しない |
